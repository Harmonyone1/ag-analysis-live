...
# Analyze interesting stocks
stocks_to_analyze = ['BA', 'INTC', 'AAPL', 'TSLA', 'ORCL', 'IBM']
...
for sym in stocks_to_analyze:
    ...
    if r:
        ...
        if r['d1_trend'] == 'BULL' and r['zone'] == 'DISCOUNT' and r['d1_rsi'] < 50:
            bias = 'BULLISH - Look for longs on pullbacks'
        elif r['d1_trend'] == 'BEAR' and r['zone'] == 'PREMIUM' and r['d1_rsi'] > 50:
            bias = 'BEARISH - Look for shorts on rallies'
        elif r['d1_trend'] == 'BULL' and r['zone'] == 'PREMIUM':
            bias = 'CAUTION - Extended, wait for pullback'
        elif r['d1_trend'] == 'BEAR' and r['zone'] == 'DISCOUNT':
            bias = 'CAUTION - Oversold, watch for reversal'
        else:
